...
SAH_KD_TREE_INLINE void sah_kd_tree::Projection<Traits>::decoupleEventBoth(const thrust::device_vector<I> & nodeSplitDimension, const thrust::device_vector<I> & polygonSide)
{
