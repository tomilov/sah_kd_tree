...
SAH_KD_TREE_INLINE void sah_kd_tree::Projection<Traits>::generateInitialEvent()
{
    ...
    auto planarEventCount = sizeToU<U>(thrust::count_if(triangleBboxBegin, thrust::next(triangleBboxBegin, triangle.count), isPlanarEvent));
