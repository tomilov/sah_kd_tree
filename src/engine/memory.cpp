...
void * AllocationCallbacks::allocation(
    size_t size,
    size_t alignment,
    [[maybe_unused]] vk::SystemAllocationScope allocationScope)
{
...
void AllocationCallbacks::internalAllocation(
    [[maybe_unused]] size_t size,
    [[maybe_unused]] vk::InternalAllocationType allocationType,
    [[maybe_unused]] vk::SystemAllocationScope allocationScope)
{
    SPDLOG_DEBUG("Internal allocation mem size {}, allocation type: {}, system allocation scope: {}", size, allocationType, allocationScope);
}

void AllocationCallbacks::internalFreeNotification(
    [[maybe_unused]] size_t size,
    [[maybe_unused]] vk::InternalAllocationType allocationType,
    [[maybe_unused]] vk::SystemAllocationScope allocationScope)
{
