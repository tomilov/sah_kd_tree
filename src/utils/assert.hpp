...
void assertFailed [[noreturn]] (const char * expression, spdlog::source_loc sourceLoc, fmt::format_string<Args...> format, Args &&... args)
{
    vAssertFailed(expression, sourceLoc, format, fmt::make_format_args(args...));
}

template<typename... Args>
void throwInvariantError [[noreturn]] (const char * expression, spdlog::source_loc sourceLoc, fmt::format_string<Args...> format, Args &&... args)
{
